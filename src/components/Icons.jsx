export const IconNombreCompleto = () => {
	return (
		<svg
...
export const IconPasswordInvisible = () => {
	return (
		<svg
			xmlns='http://www.w3.org/2000/svg'
			fill='none'
...
export const IconAdminNoticeAll = ({ iconState }) => {
	return (
		<svg
			xmlns='http://www.w3.org/2000/svg'
			fill='none'
...
export const IconAdminNoticeCreate = ({ iconState }) => {
	return (
		<svg
			xmlns='http://www.w3.org/2000/svg'
			fill='none'
...
export const IconAdminNoticeDelete = () => {
	return (
		<svg
			xmlns='http://www.w3.org/2000/svg'
			fill='none'
...
export const IconAddPublicacion = () => {
	return (
		<svg
			xmlns='http://www.w3.org/2000/svg'
			fill='none'
